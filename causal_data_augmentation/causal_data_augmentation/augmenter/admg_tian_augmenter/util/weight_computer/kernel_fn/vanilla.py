...
class VanillaProductKernel:
    ...
    def __call__(self, data: np.ndarray) -> np.ndarray:
        ...
        for k, vtype in enumerate(self.vartypes):
            ...
            # To check kernel and bandwidth adaptation
            # print(vtype)
            # print(func)
            # print(VanillaProductKernelConfig().conti_kertype)
            # print(VanillaProductKernelConfig().ordered_kertype)
            # print(VanillaProductKernelConfig().unordered_kertype)
            # print(self.bandwidths[k])
